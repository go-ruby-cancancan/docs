...
Contributions are welcome. `go-ruby-cancancan/cancancan` is built to a small set of
...
The library is in [`github.com/go-ruby-cancancan/cancancan`](https://github.com/go-ruby-cancancan/cancancan).
This documentation site is in [`github.com/go-ruby-cancancan/docs`](https://github.com/go-ruby-cancancan/docs).
