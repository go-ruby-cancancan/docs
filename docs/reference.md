...
The public API lives at the module root (`github.com/go-ruby-cancancan/cancancan`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `cancancan`, while the surface follows
...
```go
import "github.com/go-ruby-cancancan/cancancan"
```
...
- **[pkg.go.dev/github.com/go-ruby-cancancan/cancancan](https://pkg.go.dev/github.com/go-ruby-cancancan/cancancan)**

The module's [README](https://github.com/go-ruby-cancancan/cancancan#readme) carries worked
