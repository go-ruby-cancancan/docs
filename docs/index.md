...
| Repo | What it is |
| --- | --- |
| [`cancancan`](https://github.com/go-ruby-cancancan/cancancan) | the library — Ruby's `cancancan` in pure Go |
| [`docs`](https://github.com/go-ruby-cancancan/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-cancancan.github.io`](https://github.com/go-ruby-cancancan/go-ruby-cancancan.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-cancancan/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-cancancan/cancancan](https://github.com/go-ruby-cancancan/cancancan).
